...
def descargar_listado_emitidos(
    ...
    *,
    ...
    try:
        ...
        time.sleep(0.3)
        # TENTATIVO: en emitidos el combo de tipo puede no existir o llamarse
        # distinto; si no aparece seguimos igual (el portal suele traer todos).
        try:
            _select_first(
                page,
        ...
        # TENTATIVO: en emitidos el link puede llamarse distinto (a veces
        # "Descargar reporte"); por eso hay varios fallbacks.
        link = None
        for sel in [
