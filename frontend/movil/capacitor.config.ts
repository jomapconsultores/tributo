...
// Empaquetado móvil de Gestor Tributario.
//
...
//
// El destino es el despliegue en Coolify: https://tributos.pensamiento-libre.org
...
const APP_URL = process.env.APP_URL || 'https://tributos.pensamiento-libre.org';

const config: CapacitorConfig = {
  appId: 'ec.map.tributos',
  appName: 'Gestor Tributario',
  webDir: 'www',
