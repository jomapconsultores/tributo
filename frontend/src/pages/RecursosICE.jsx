...
import { resourcesAPI, downloadBlob } from '../services/api'
    ...
    <div className="rec-page">
      ...
      <div className="rec-card">
        ...
        <div className="rec-body">
          ...
          <p className="rec-note">Este archivo es <strong>reemplazable</strong>: sube una versión nueva cuando se actualice.</p>
          <div className="rec-actions">
            ...
            <button className="rec-btn replace" onClick={() => fileRef.current?.click()}>🔁 Reemplazar</button>
          </div>
