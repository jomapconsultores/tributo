...
export function AccessProvider({ children }) {
  const [state, setState] = useState({ modules: [], isAdmin: false, loading: true })

  useEffect(() => {
    accessAPI.me()
      .then((r) => setState({ modules: r.data?.modules || [], isAdmin: !!r.data?.is_admin, loading: false }))
      .catch(() => setState({ modules: [], isAdmin: false, loading: false }))
  }, [])
