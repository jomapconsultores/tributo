...
export function calcRow(r, anio, mes) {
  ...
  let iceAdv = 0
  // Ad-valorem (75% sobre el excedente del umbral): aplica a todas las bebidas
  // alcohólicas (alcohólicas, artesanal e industrial) cuando precio/litro > umbral.
  const aplicaAdv = precioLitro > umbral
